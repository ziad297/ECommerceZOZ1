...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    TextView productName, productCategory, productPrice, productDescription,productId,productQuant;
...
////                productprice
    ...
    private void addToCart(final String productid) {
        ...
        map.put("productquantity",product.getQuantity());
        map.put("productprice",product.getPrice());
        map.put("adminid",product.getadminid());
    ...
    private void setProductDetails(final String productid) {
        ...
        rootRef.child("Products").child(productid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adminId.setText("admin ID : "+product.getadminid());
                productQuant.setText(product.getQuantity());
    ...
    private void init() {
        ...
        adminId = findViewById(R.id.adminName);
        adminName = findViewById(R.id.adminId);
        productId = findViewById(R.id.productid);
        productQuant = findViewById(R.id.Quant);
    }
}