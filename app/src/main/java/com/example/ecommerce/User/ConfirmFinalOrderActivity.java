...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    private void getCart() {
        FirebaseDatabase.getInstance().getReference().child("Cart").child(fUser.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            DatabaseReference userOrderRef = FirebaseDatabase.getInstance().getReference().child("Orders");
                            ...
                            map.put("adminid", cart.getadminid());
                            ...
                            userOrderRef.child("Orders").child(orderid).setValue(map)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                Intent intent = new Intent(ConfirmFinalOrderActivity.this,FeedbackActivity.class);
