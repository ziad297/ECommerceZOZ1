        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name) || TextUtils.isEmpty(number)|| TextUtils.isEmpty(address)  || TextUtils.isEmpty(email) || TextUtils.isEmpty(password)){
                    Toast.makeText(AdminRegisterActivity.this, "Fill all the credentials", Toast.LENGTH_SHORT).show();
                }else if (password.length()<6){
                    Toast.makeText(AdminRegisterActivity.this, "Lenght of Password should be greater than 6 digits", Toast.LENGTH_SHORT).show();
                }else{
